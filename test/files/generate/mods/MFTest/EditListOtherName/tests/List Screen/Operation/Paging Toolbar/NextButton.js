 ...
 * Next Button
 */
describe('Next Button', function(t) {
        ...
        t.chain(
            ...
            function(next) {
                ...
                t.click(t.getButtons().List.last, function() {
                    lastpage = t.getViews().List.getStore().lastOptions.page;
                });
            },
            // Click Next Button
            // Do not change page.
            function(next) {
                ...
                t.click(t.getButtons().List.next, function() {
    ...
    t.it('Second Page', function(t) {
        t.chain(
            ...
            function(next) {
                t.pass('Click Next Button');
                t.click(t.getButtons().List.next, function() {
                    t.is(t.getViews().List.getStore().lastOptions.page, 3, 'Move to third page.');
                    next();
                });
            }
        );
